...
exports.buildOtpEmail = void 0;
const buildOtpEmail = (data) => {
    const { username = "USER", otp, siteName = "CORE STACK", buttonText = "VERIFY EMAIL", buttonUrl = "#", supportEmail = "support@slackdev.com", logoUrl, } = data;
              ...
              <td class="content" style="padding: 16px 24px 8px; text-align:center;">
                ...
                <div style="margin: 20px 0; text-align:center;">
                  <table style="margin: 0 auto; border-collapse: separate; border-spacing: 8px;">
                    <tr>
                      ${otp.split('').map(digit => `<td style="width:45px; height:45px; border:2px solid #f97316; border-radius:8px; background:#fff; color:#f97316; font-weight:700; font-size:20px; text-align:center; vertical-align:middle;">${digit}</td>`).join('')}
                    </tr>
                  </table>
                </div>
