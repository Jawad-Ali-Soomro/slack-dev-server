...
exports.buildResetPasswordEmail = void 0;
const buildResetPasswordEmail = (data) => {
    const { username = "USER", otp, siteName = "CORE STACK", buttonText = "RESET PASSWORD", buttonUrl = "#", supportEmail = "SUPPORT@EXAMPLE.COM", } = data;
    const preheader = `YOUR ${siteName} PASSWORD RESET CODE IS ${otp}`;
    const text = `${siteName} - PASSWORD RESET\n\nHELLO ${username},\n\nYOUR PASSWORD RESET CODE IS: ${otp}\n\nIF YOU DIDN'T REQUEST THIS, IGNORE THIS MESSAGE OR CONTACT ${supportEmail}.\n\n${buttonUrl}\n\nTHANKS,\n${siteName} TEAM`;
    const html = `
  <!doctype html>
  <html>
  <head>
          ...
          <table class="container" role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" 
            ...
            <tr>
              <td style="padding: 20px; text-align:center;">
                ...
                <div style="font-size:11px; color:#8b94a6; margin-top:10px;">PASSWORD RESET</div>
              </td>
            </tr>
              ...
              <td class="content" style="padding: 16px 24px 8px; text-align:center;">
                ...
                <div style="margin: 20px 0; text-align:center;">
                  <table style="margin: 0 auto; border-collapse: separate; border-spacing: 8px;">
                    <tr>
                      ${otp.split('').map(digit => `<td style="width:45px; height:45px; border:2px solid #dc2626; border-radius:8px; background:#fff; color:#dc2626; font-weight:700; font-size:20px; text-align:center; vertical-align:middle;">${digit}</td>`).join('')}
                    </tr>
                  </table>
                </div>
                  ...
                  <tr>
                    <td align="center">
                      <a href="${buttonUrl}" target="_blank" 
                        style="background-color:#dc2626; color:#ffffff; padding:10px 24px; border-radius:6px; text-decoration:none; display:inline-block; font-weight:600; font-size:12px;">
                        ${buttonText}
                      </a>
                    </td>
                  </tr>
                ...
                <p style="margin:0; line-height:1.4;">
                  ...
                  <a href="mailto:${supportEmail}" style="color:#dc2626; text-transform:none !important; margin-top: 10px !important; margin-bottom: 20px; ">${supportEmail}</a>
                </p>
              </td>
            </tr>
